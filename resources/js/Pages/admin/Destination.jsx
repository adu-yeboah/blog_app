            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full p-2 border border-gray-300 focus:border-green-700 outline-0 rounded-md"
              ...
              <div>
                <button
                  type="submit"
                  disabled={processing}
                  className={`w-full bg-green-800 text-white py-2 rounded-md ${processing ? 'opacity-50 cursor-not-allowed' : 'hover:bg-green-700'}`}
                >
