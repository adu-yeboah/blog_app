...
import { Facebook, Twitter, Instagram, Linkedin, Youtube, SendHorizonal } from 'lucide-react';
    ...
    return (
        <footer className="bg-gray-900 text-white py-8 px-6">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-gray-400">
                        ...
                        <li><a href="/destination" className="hover:text-white">Destination</a></li>
                ...
                <div>
                    ...
                    <div className="flex">
                        <input
                            ...
                            className="w-full bg-white p-2 rounded-l-md text-black"
                        />
            ...
            <div className="mt-8 text-center text-gray-500 text-sm">
                <p>© 2025 Wanderlust Ghana. All rights reserved.</p>
            </div>
